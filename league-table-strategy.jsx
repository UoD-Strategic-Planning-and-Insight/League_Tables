...
const METRICS = [
  ...
  { id: "facilities_spend",  label: "Facilities Spend",               controllability: 80, description: "Expenditure on student facilities per student (£)", unit: "£", min: 200, max: 3800, benchmarkLow: 720, benchmarkMid: 1930, benchmarkTop: 3757, sourceused: "CUG" },
...
const WEIGHTS = {
  ...
  dailymail:  { nss_teaching_quality: 0,  nss_assessment: 0,  nss_overall: 0,  nss_student_experience: 5, nss_support: 10, nss_teaching_excellence: 10, nss_teaching_on_course: 0,  continuation: 5,  graduate_outcomes: 15, entry_tariff: 5,  staff_student: 0,  facilities_spend: 0, research_quality: 10, research_intensity: 0, degree_classification: 10, research_income: 5, graduate_on_track: 5, graduate_salaries: 5, academic_services_spend: 0, first_generation: 10, value_added: 0, people_planet: 0},
};
