...
const METRICS = [
  { id: "nss_teaching_quality",      label: "NSS: Teaching Quality",          controllability: 74, description: "National Student Survey — teaching on my course", unit: "%", min: 60, max: 100, benchmarkLow: 78, benchmarkMid: 83, benchmarkTop: 88 },
  { id: "nss_assessment",    label: "NSS: Assessment & Feedback",     controllability: 78, description: "National Student Survey — assessment & feedback", unit: "%", min: 50, max: 100, benchmarkLow: 68, benchmarkMid: 74, benchmarkTop: 82 },
  { id: "nss_overall",       label: "NSS: Overall Satisfaction",      controllability: 58, description: "National Student Survey — overall satisfaction score", unit: "%", min: 55, max: 100, benchmarkLow: 76, benchmarkMid: 82, benchmarkTop: 88 },
  { id: "nss_student_experience", label: "NSS: Student Experience", controllability: 63, description: "National Student Survey - student experience score", unit: "%", min: 55, max: 100, benchmarkLow: 76, benchmarkMid: 82, benchmarkTop: 88 },
  { id: "nss_support", label: "NSS: Student Support", controllability: 71, description: "National Student Survey - student support score", unit: "%", min: 55, max: 100, benchmarkLow: 76, benchmarkMid: 82, benchmarkTop: 88 },
  { id: "nss_teaching_excellence", label: "NSS: Teaching Excellence", controllability: 73, description: "National Student Survey - teaching excellence score", unit: "%", min: 55, max: 100, benchmarkLow: 76, benchmarkMid: 82, benchmarkTop: 88 },
  { id: "nss_teaching_on_course", label: "NSS:Teaching on my Course", controllability: 74, description: "National Student Survey - teaching on my course score", unit: "%", min: 55, max: 100, benchmarkLow: 76, benchmarkMid: 82, benchmarkTop: 88 },
  { id: "continuation",      label: "Continuation / Completion",       controllability: 67, description: "% of students continuing to next year of study", unit: "%", min: 70, max: 100, benchmarkLow: 86, benchmarkMid: 90, benchmarkTop: 95 },
  { id: "graduate_outcomes", label: "Graduate Outcomes (Employment)",  controllability: 47, description: "% in highly skilled employment or further study 15 months after graduation (HESA)", unit: "%", min: 55, max: 100, benchmarkLow: 68, benchmarkMid: 75, benchmarkTop: 84 },
  { id: "entry_tariff",      label: "Entry Tariff",                   controllability: 36, description: "Average UCAS tariff points of new entrants", unit: "pts", min: 80, max: 220, benchmarkLow: 115, benchmarkMid: 140, benchmarkTop: 175 },
  { id: "staff_student",     label: "Staff–Student Ratio",            controllability: 82, description: "Students per academic FTE (lower = better)", unit: ":1", min: 8, max: 35, benchmarkLow: 20, benchmarkMid: 16, benchmarkTop: 12, lowerIsBetter: true },
  { id: "spend_per_student", label: "Academic Services Spend",        controllability: 84, description: "Expenditure on academic services per student (£)", unit: "£", min: 500, max: 5000, benchmarkLow: 1200, benchmarkMid: 1800, benchmarkTop: 2800 },
  { id: "facilities_spend",  label: "Facilities Spend",               controllability: 80, description: "Expenditure on student facilities per student (£)", unit: "£", min: 200, max: 3000, benchmarkLow: 800, benchmarkMid: 1200, benchmarkTop: 2000 },
  { id: "research_quality",  label: "Research Quality (REF)",         controllability: 34, description: "GPA-weighted REF output/impact/environment scores (max 4.0)", unit: "GPA", min: 1.0, max: 4.0, benchmarkLow: 2.4, benchmarkMid: 2.8, benchmarkTop: 3.3 },
  { id: "research_intensity",label: "Research Intensity",             controllability: 44, description: "Proportion of staff submitted to REF (%)", unit: "%", min: 10, max: 100, benchmarkLow: 45, benchmarkMid: 62, benchmarkTop: 80 },
  { id: "degree_classification", label: "Good Honours Rate",          controllability: 52, description: "% of graduates achieving 1st or 2:1", unit: "%", min: 50, max: 100, benchmarkLow: 72, benchmarkMid: 78, benchmarkTop: 85 },
  { id: "research_income", label: "Research Income", controllability: 39, description: "Per capita measure of research grants and contracts", unit: "£", min: 200, max: 3000, benchmarkLow: 800, benchmarkMid: 1200, benchmarkTop: 2000 },
  ...
  { id: "graduate_salaries", label: "Graduate Salaries", controllability: 18, description: "median salary of first-degree, UK-domiciled graduates in full-time paid UK employment", unit: "£", min: 200, max: 3000, benchmarkLow: 800, benchmarkMid: 1200, benchmarkTop: 2000 },
  { id: "academic_services_spend", label: "Academic Services Spend", controllability: 84, description: "how much a university spends on library and computing facilities per student FTE", unit: "£", min: 200, max: 3000, benchmarkLow: 800, benchmarkMid: 1200, benchmarkTop: 2000 },
  { id: "first_generation", label: "First Generation Students", controllability: 28, description: "The proportion of UK-domiciled undergraduate students whose parents did not attend university", unit: "%", min: 10, max: 100, benchmarkLow: 45, benchmarkMid: 62, benchmarkTop: 80 },
  { id: "value_added", label: "Value Added Score", controllability: 61, description: "Tracks student from enrolment to graduation and how a university supports its students towards good grades", unit: "pts", min: 80, max: 220, benchmarkLow: 115, benchmarkMid: 140, benchmarkTop: 175 },
  { id: "people_planet", label: "People & Planet Score", controllability: 69, description: "Score derived from the sustainability ranking People & Planet", unit: "pts", min: 80, max: 220, benchmarkLow: 115, benchmarkMid: 140, benchmarkTop: 175 }
];
...
const WEIGHTS = {
  ...
  dailymail:  { nss_teaching_quality: 0,  nss_assessment: 0,  nss_overall: 0,  nss_student_experience: 5, nss_support: 10, nss_teaching_excellence: 10, nss_teaching_on_course: 0,  continuation: 15,  graduate_outcomes: 15, entry_tariff: 5,  staff_student: 0,  spend_per_student: 0, facilities_spend: 0, research_quality: 10, research_intensity: 0, degree_classification: 10, research_income: 5, graduate_on_track: 5, graduate_salaries: 5, academic_services_spend: 0, first_generation: 10, value_added: 0, people_planet: 0},
};

const CONTROLLABILITY_BANDS = [
  { min: 65, label: "High Control",   color: "#22c55e", bg: "#f0fdf4" },
