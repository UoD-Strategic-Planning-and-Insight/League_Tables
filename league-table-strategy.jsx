...
const METRICS = [
  { id: "nss_teaching_quality",      label: "NSS: Teaching Quality",          controllability: 72, description: "National Student Survey — teaching quality", unit: "%", min: 60, max: 100, benchmarkLow: 72, benchmarkMid: 84.55, benchmarkTop: 92.2, sourceused: "Times", dundee_2026_score: 87.2 },
  { id: "nss_assessment",    label: "NSS: Assessment & Feedback",     controllability: 78, description: "National Student Survey — assessment & feedback", unit: "%", min: 50, max: 100, benchmarkLow: 65, benchmarkMid: 81.4, benchmarkTop: 92.6, sourceused: "Guardian", dundee_2026_score: 80.1 },
  { id: "nss_overall",       label: "NSS: Overall Satisfaction",      controllability: 58, description: "National Student Survey — overall satisfaction score", unit: "%", min: 55, max: 100, benchmarkLow: 68, benchmarkMid: 78, benchmarkTop: 83, sourceused: "CUG", dundee_2026_score: 79 },
  { id: "nss_student_experience", label: "NSS: Student Experience", controllability: 63, description: "National Student Survey - student experience score", unit: "%", min: 55, max: 100, benchmarkLow: 65.9, benchmarkMid: 81.1, benchmarkTop: 88.7, sourceused:"Times", dundee_2026_score: 81.3 },
  { id: "nss_support", label: "NSS: Student Support", controllability: 71, description: "National Student Survey - student support score", unit: "%", min: 55, max: 100, benchmarkLow: 70.1, benchmarkMid: 82.7, benchmarkTop: 91.4, sourceused: "DailyMail", dundee_2026_score: 82.9 },
  { id: "nss_teaching_excellence", label: "NSS: Teaching Excellence", controllability: 73, description: "National Student Survey - teaching excellence score", unit: "%", min: 55, max: 100, benchmarkLow: 72.4, benchmarkMid: 85.2, benchmarkTop: 92.5, sourceused: "DailyMail", dundee_2026_score: 88.5 },
  { id: "nss_teaching_on_course", label: "NSS:Teaching on my Course", controllability: 74, description: "National Student Survey - teaching on my course score", unit: "%", min: 55, max: 100, benchmarkLow: 80.1, benchmarkMid: 82, benchmarkTop: 94, sourceused: "Guardian", dundee_2026_score: 89 },
  { id: "entry_tariff",      label: "Entry Tariff",                   controllability: 56, description: "Average UCAS tariff points of new entrants", unit: "pts", min: 80, max: 220, benchmarkLow: 93, benchmarkMid: 123, benchmarkTop: 210, sourceused: "Guardian", dundee_2026_score: 184 },
  { id: "staff_student",     label: "Staff–Student Ratio",            controllability: 72, description: "Students per academic FTE (lower = better)", unit: ":1", min: 8, max: 35, benchmarkLow: 23, benchmarkMid: 15.1, benchmarkTop: 9.1, lowerIsBetter: true, sourceused: "Guardian", dundee_2026_score: 12 },
  { id: "continuation",      label: "Continuation / Completion",       controllability: 67, description: "% of students continuing to next year of study", unit: "%", min: 70, max: 100, benchmarkLow: 75.9, benchmarkMid: 89.2, benchmarkTop: 98.4, sourceused: "Guardian", dundee_2026_score: 90.6 },
  { id: "degree_classification", label: "Good Honours Rate",          controllability: 52, description: "% of graduates achieving 1st or 2:1", unit: "%", min: 50, max: 100, benchmarkLow: 54, benchmarkMid: 75.6, benchmarkTop: 93, sourceused: "Times", dundee_2026_score: 82 },  
  { id: "graduate_outcomes", label: "Graduate Outcomes (Employment)",  controllability: 47, description: "% in highly skilled employment or further study 15 months after graduation (HESA)", unit: "%", min: 55, max: 100, benchmarkLow: 67, benchmarkMid: 79, benchmarkTop: 95, sourceused: "Guardian", dundee_2026_score: 87 },
  { id: "graduate_on_track", label: "Graduate Prospects on Track", controllability: 50, description: "Measure of how many students felt their career is on track", unit: "%", min: 0, max: 100, benchmarkLow: 62.3, benchmarkMid: 75.7, benchmarkTop: 86.9, sourceused: "CUG", dundee_2026_score: 79.2 },
  { id: "graduate_salaries", label: "Graduate Salaries", controllability: 18, description: "median salary of first-degree, UK-domiciled graduates in full-time paid UK employment", unit: "£", min: 20000, max: 40000, benchmarkLow: 22000, benchmarkMid: 27500, benchmarkTop: 37000, sourceused: "DailyMail", dundee_2026_score: 27500 },
  { id: "academic_services_spend", label: "Academic Services Spend",        controllability: 84, description: "Expenditure on academic services per student (£)", unit: "pts", min: 0, max: 10, benchmarkLow: 1.7, benchmarkMid: 4.9, benchmarkTop: 10, sourceused: "Guardian", dundee_2026_score: 0 },
  { id: "facilities_spend",  label: "Facilities Spend",               controllability: 80, description: "Expenditure on student facilities per student (£)", unit: "£", min: 200, max: 3800, benchmarkLow: 117, benchmarkMid: 691.5, benchmarkTop: 2164, sourceused: "CUG", dundee_2026_score: 683 },
  { id: "research_quality",  label: "Research Quality (REF)",         controllability: 34, description: "GPA-weighted REF output/impact/environment scores (max 4.0)", unit: "GPA", min: 1.0, max: 4.0, benchmarkLow: 1.74, benchmarkMid: 2.99, benchmarkTop: 3.63, sourceused: "CUG", dundee_2026_score: 3.23 },
  { id: "research_intensity",label: "Research Intensity",             controllability: 44, description: "Proportion of staff submitted to REF (%)", unit: "%", min: 10, max: 100, benchmarkLow: 10, benchmarkMid: 45.5, benchmarkTop: 100, sourceused: "CUG", dundee_2026_score: 41 },
  { id: "research_income", label: "Research Income", controllability: 39, description: "Per capita measure of research grants and contracts", unit: "£", min: 0, max: 120000, benchmarkLow: 0, benchmarkMid: 14637, benchmarkTop: 111032, sourceused: "DailyMail", dundee_2026_score: 76750 }, 
  { id: "first_generation", label: "First Generation Students", controllability: 28, description: "The proportion of UK-domiciled undergraduate students whose parents did not attend university", unit: "%", min: 10, max: 100, benchmarkLow: 15.7, benchmarkMid: 43, benchmarkTop: 73.6, sourceused: "DailyMail", dundee_2026_score: 31.1 },
  { id: "value_added", label: "Value Added Score", controllability: 61, description: "Tracks student from enrolment to graduation and how a university supports its students towards good grades", unit: "pts", min: 0, max: 10, benchmarkLow: 2, benchmarkMid: 5.4, benchmarkTop: 8, sourceused: "CUG", dundee_2026_score: 5.7 },
  { id: "people_planet", label: "People & Planet Score", controllability: 69, description: "Score derived from the sustainability ranking People & Planet", unit: "pts", min: 10, max: 100, benchmarkLow: 10.5, benchmarkMid: 50.6, benchmarkTop: 80.7, sourceused: "Times", dundee_2026_score: 29.4 }
];
...
const WEIGHTS = {
  guardian:   { nss_teaching_quality: 0,    nss_assessment: 10, nss_overall: 0,     nss_student_experience: 0,    nss_support: 0,  nss_teaching_excellence: 0,  nss_teaching_on_course: 10, continuation: 15,    graduate_outcomes: 15,    entry_tariff: 15,   staff_student: 15,    facilities_spend: 0,    research_quality: 0,       research_intensity: 0,    degree_classification: 0,    research_income: 0, graduate_on_track: 0,    graduate_salaries: 0, academic_services_spend: 5,    first_generation: 0,  value_added: 15, people_planet: 0},
  times:      { nss_teaching_quality: 12.5, nss_assessment: 0,  nss_overall: 0,     nss_student_experience: 6.25, nss_support: 0,  nss_teaching_excellence: 0,  nss_teaching_on_course: 0,  continuation: 12.5,  graduate_outcomes: 18.75, entry_tariff: 12.5, staff_student: 0,     facilities_spend: 0,    research_quality: 18.75,   research_intensity: 0,    degree_classification: 12.5, research_income: 0, graduate_on_track: 0,    graduate_salaries: 0, academic_services_spend: 0,    first_generation: 0,  value_added: 0,  people_planet: 6.25},
  cug:        { nss_teaching_quality: 0,    nss_assessment: 0,  nss_overall: 18.75, nss_student_experience: 0,    nss_support: 0,  nss_teaching_excellence: 0,  nss_teaching_on_course: 0,  continuation: 12.5,  graduate_outcomes: 8.38,  entry_tariff: 12.5, staff_student: 12.50, facilities_spend: 6.25, research_quality: 12.5,    research_intensity: 6.25, degree_classification: 0,    research_income: 0, graduate_on_track: 4.13, graduate_salaries: 0, academic_services_spend: 6.25, first_generation: 0,  value_added: 0,  people_planet: 0},
...
export default function App() {
  ...
  const initialPerf = Object.fromEntries(METRICS.map(m => [m.id, m.dundee_2026_score !== undefined ? m.dundee_2026_score : ""]));
  const [perfData, setPerfData] = useState(initialPerf);
  const [dataEntered, setDataEntered] = useState(hasAnyData(initialPerf));
      ...
      <div style={{ background: "#1a1a2e", color: "#f8f7f4", padding: "28px 40px 24px", borderBottom: "4px solid #c8a96e" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
            ...
            <a href="/League_Tables/international/" style={{ marginTop: 4, padding: "6px 14px", background: "rgba(200,169,110,0.15)", border: "1px solid #c8a96e", borderRadius: 20, color: "#c8a96e", fontSize: 12, textDecoration: "none", whiteSpace: "nowrap", flexShrink: 0 }}>World Rankings &#8594;</a>
          </div>
        </div>
      </div>
