...
const METRICS = [
  ...
  { id: "spend_per_student", label: "Academic Services Spend",        controllability: 50, description: "Expenditure on academic services per student (£)", unit: "£", min: 500, max: 5000, benchmarkLow: 1200, benchmarkMid: 1800, benchmarkTop: 2800 },
  { id: "facilities_spend",  label: "Facilities Spend",               controllability: 48, description: "Expenditure on student facilities per student (£)", unit: "£", min: 200, max: 3000, benchmarkLow: 800, benchmarkMid: 1200, benchmarkTop: 2000 },
